  ...
  return (
    <div>
      ...
      <div className="user-container">
        ...
        <h2 className='pt-4 font-bold text-2xl'>Ласкаво просимо в наш інтернет-магазин «RWTrade»!</h2>
        <div className='grid grid-cols-2 pt-4 pb-4 gap-10 sm:gap-24'>
          <div>
            <p className='mb-2 sm:mb-6'>Наш магазин спеціалізується на гуртово-роздрібній продаж автотоварів, автоелектроніки і автоинструмента.
            Наша діяльність розпочалася більше дев'яти років тому як інтернет-магазин автоелектроніки. Поступово розвиваючись, ми істотно розширили асортимент нашого магазину, додаючи актуальний і затребуваний товар. Результатом нашої багаторічної роботи стало створення ряду інтернет-магазинів з різною тематикою і асортиментом.</p>
            <h2 className='font-semibold mb-2 sm:mb-6'>Автотовари оптом і в роздріб</h2>
            <p className='mb-2 sm:mb-6'>У нашому інтернет-магазині ми пропонуємо якісну і популярну автоелектроніку за конкурентними цінами!</p>
            ...
            <ul className='list-disc ml-5 mb-2 sm:mb-6'>
              ...
              <li>Працюємо як оптом так і в роздріб без обмежень за сумою і кількістю;</li>
