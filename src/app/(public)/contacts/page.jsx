      ...
      <div className="user-container">
        ...
        <div className="grid grid-cols-2 py-4 gap-10 sm:gap-24">
          ...
          <div className="max-w-[660px] text-2xl">
            <p className="gradient-text font-semibold mb-8">RW Trade - товари високої якості!</p>

            <p className='font-bold'>Відділ продажу</p>
            <p className='mb-8'>вул. Дмитра Коцюбайла (Державінська), 38, 2 поверх, офіс 215, Харків, Україна</p>
