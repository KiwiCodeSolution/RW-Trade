export const fakeProducts = (strNum, category='any', subCategory='any') => {
  ...
  const adjectives = ['Awesome', 'Elegant', 'Modern', 'Stylish', 'Durable', 'Premium', 'Luxury', 'Compact', 'Wireless', 'Smart'];
  const nouns = ['Gadget', 'Device', 'Tool', 'Kit', 'System', 'Console', 'Phone', 'Watch', 'Speaker', 'Lamp'];
  const features = ['long-lasting battery', 'eco-friendly design', 'high precision', 'easy to use', 'Bluetooth connectivity', 'voice control', 'LED display', 'portable charging', 'ultra-fast performance', 'sleek look'];
  const verbs = ['enhance', 'improve', 'boost', 'simplify', 'transform', 'revolutionize', 'optimize'];
  ...
  const getRandomPrice = () =>
    parseFloat((Math.random() * (90000 - 10) + 10).toFixed(2)); // Random price between 10 and 90000
